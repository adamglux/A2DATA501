...
The following are the specific steps taken to build this R package. 

### initial steps

The package uses one function, `influenceR()`, which was first built and tested in this Rmarkdown file. (please see code chunks below). Once the functionality was sufficiently acceptable, a new project was created and synced with a git repository.  
